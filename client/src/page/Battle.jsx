...
import { Alert,GameInfo,PlayerInfo,ActionButton,Card,CustomButton } from '../components'
import { useGlobalContext } from '../context'
import {attack,defense,attackSound,defenseSound,player01 as player01Icon,player02 as player02Icon} from '../assets'
import {playAudio} from '../utils/animation.js'
const Battle = () => {
    const {contract,player1Ref,player2Ref,gameData,showAlert,setShowAlert,walletAddress,battleGround,setErrorMessage,setBattleGround,settErrorMessage,updateCurrentWalletAddress} = useGlobalContext();
  ...
  return (
    <div className={`${styles.flexBetween} ${styles.gameContainer} ${battleGround}`}>
        ...
        <div className={`${styles.flexCenter} flex-col my-5`}>
            <Card 
                card = {player2}
