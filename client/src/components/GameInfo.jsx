...
const GameInfo = () => {
  ...
  const handleBattleExit = async()=>{
    ...
    try {
      ...
      setShowAlert({
        status:true,
        type: 'info',
        message: "You are quitiing the battle"
      })
    } catch (error) {
  ...
  return (
    <>
      ...
      <div className={`${styles.gameInfoSidebar} ${toggleSidebar ? 'translate-x-0': 'translate-x-full'} ${styles.glassEffect} ${styles.flexBetween} backdrop-blur`}>
